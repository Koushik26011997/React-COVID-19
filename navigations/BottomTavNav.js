...
const BottomTabNav = ({ navigation }) => {
    return (
        <BottomTab.Navigator screenOptions={{ tabBarColor: '#0C1C46' }} initialRouteName={Home}>
            ...
            <BottomTab.Screen name="Datewise" component={Datewise} options={{
                tabBarLabel: 'Dates',
                tabBarColor: '#007bff',
                tabBarIcon: ({ color }) => (
                    <TouchableOpacity>
                        <Icon size={TAB_BAR_ICON_SIZE} color="white" name="calendar-range" />
                    </TouchableOpacity>
                ),
            }} />
            ...
            <BottomTab.Screen name="Districtwise" component={Vaccine} options={{
                ...
                tabBarIcon: ({ color }) => (
                    <TouchableOpacity>
                        <Icon size={TAB_BAR_ICON_SIZE} color="white" name="gesture-spread" />
                    </TouchableOpacity>
                ),
            }} />

            <BottomTab.Screen name="Chart" component={Chart} options={{
                tabBarLabel: 'Chart',
                tabBarColor: '#6c757d',
                tabBarIcon: ({ color }) => (
                    <TouchableOpacity>
