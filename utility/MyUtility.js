...
export const showFlashMessage = (message = '', description = '', type = 'success', onPress = () => { }, duration = 2000) => {
    showMessage({
        message: message,
...
export const timeDiff = (startDateTime) => {
    if (startDateTime !== "") {
        ...
        if (totalHours === 0) {
            if (clearMinutes === 1)
                return "(" + clearMinutes + " Min ago)";
            else
                return "(" + clearMinutes + " Mins ago)";
        }
            ...
            if (clearMinutes === 0)
                ...
                return "(" + totalHours + " Hr & " + clearMinutes + " Mins ago)";
        }
        else if (totalHours > 1) {
            if (clearMinutes === 0)
