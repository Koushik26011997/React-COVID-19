...
export const FAQ_DATA = {
  ...
  faq: [
    ...
    {
      answer:
        'MoHFW updates the data at a scheduled time. However, we update them based on state press bulletins, official (CM, Health Ministry) handles, PBI, Press Trust of India, ANI reports. These are generally more recent.',
      category: 'Data',
      qno: '3',
      question:
        'Why does this app has difference in numbers compared to MOHFW website?',
    },
    {
      answer:
        'All the data is available through an API for further analysis and development here: https://api.covid19india.org',
      qno: '4',
    ...
    {
      answer:
        'Well, my name is Mr. Koushik Paul and I am a software developer at Idiosys Technology PVT. LTD. Kolkata. I work to build Android & React Native Apps.',
      category: 'General',
      qno: '7',
