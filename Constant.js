...
export const FAQ_DATA = {
    ...
    "faq": [
        ...
        {
            "answer": "We are using state bulletins and official handles to update our numbers. The data is validated by a group of volunteers and published into a Google sheet and an API.",
            "category": "General",
            "qno": "2",
            "question": "What are your sources? How is the data gathered for this project?"
        },
        {
            "answer": "MoHFW updates the data at a scheduled time. However, we update them based on state press bulletins, official (CM, Health Ministry) handles, PBI, Press Trust of India, ANI reports. These are generally more recent.",
            "category": "Data",
            "qno": "3",
            "question": "Why does this app has difference in numbers compared to MOHFW website?"
        },
        {
            "answer": "All the data is available through an API for further analysis and development here: https://api.covid19india.org",
            "qno": "4",
        ...
        {
            "answer": "Because it affects all of us. Today it's someone else who is getting infected; tomorrow it could be us. We need to prevent the spread of this virus. We need to document the data so that people with knowledge can use this data to make informed decisions.",
            "category": "General",
            "qno": "6",
        ...
        ,
        {
            "answer": "Well, my name is Mr. Koushik Paul and I am a software developer at Idiosys Technology PVT. LTD. Kolkata. I work to build Android & React Native Apps.",
            "category": "General",
            "qno": "7",
            "question": "What is your name and what you do?"
        }
    ]
}